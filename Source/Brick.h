...
public:
	...
	Brick(float x, float y) : Entity(x, y), m_Width(DEFAULT_BRICK_WIDTH), m_Height(DEFAULT_BRICK_HEIGHT), m_IsReachable(false) { LoadTexture(TEXTUREBALL); SetSpritePos(x, y); }
